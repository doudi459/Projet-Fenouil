            ...
            <div class="row second-rawn">
                <div class="col-xs-12 col-sm-12 col-md-5 extraspac">
                    <div class="et-team-col et-innerteam">
                        <img class="img-responsive img-fluid" src="http://localhost/www/Prog/public/images/{{$art->imag}}" style="height: 400px;" alt="">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 et-tm-skill">Apressiation <span class="text-thm">Prix : {{$art->Prixdevents}} £</span></div>
                        <div class="col-md-6">
                            <!--Progress Levels-->
        ...
        <div class="modal-content ">
            ...
            <div class="container">
                ...
                <div class="from-groupe">
                    ...
                    <img src ='http://localhost/www/Prog/public/images/erreur.png' class='zoomIn rounded img-circle' style="right: 25%;">
        ...
        <div class="modal-content ">
            ...
            <div class="container">
                ...
                <div class="from-groupe">
                    ...
                    <h5 class="text-lg-center text-thm et-tm-skill" >votre commande a etait ajouté au panié avec succée. </h5>
                    <h2 class="text-lg-center">Vous devais confirmé votre commande . </h2>
                </div>
