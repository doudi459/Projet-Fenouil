                        ...
                        <td class="center" >
                            <div class="row">
                                <div class="btn-group btn-group-xs col-lg-2" role="group" >
                                    ...
                                    <span class="vl"></span>
                                    {!! Form::open(array('url' => 'http://localhost/www/Prog/public/dashbord/ToutLesCible/' . $art->num_cible , 'class' => 'pull-right')) !!}
        ...
        var preview = function (obj) {
           ...
           var element = ["name","prenom","Adress","categori_socio","Age","Email","NumTell"];
            ...
            $.ajax({
                ...
                type: 'GET',
                url:'http://localhost/www/Prog/public/dashbord/ToutLesCible/' + obj.id ,
