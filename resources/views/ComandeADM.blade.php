                        ...
                        <td class="center" >
                            <div class="row">
                                ...
                                <div class="btn-group btn-group-xs col-lg-2 col-lg-offset-9" role="group" >
                                    <button type="button"  data-id = "{{$art->num_commande}}" class="btn  btn-link btn-sm" style="padding-right: 3px; color: #20c997"  onclick="preview(this);">Voire les articles</button>
                                    <span class="vl"></span>
                                    <span class="vl"></span>
            ...
            Validé Votre commande
                            ...
                            @if(isset($Arts))
                                ...
                                @foreach($Arts[2 * $i + 1] as $arts )
                                    ...
                                    <div class="row" >
                                        <div class="col-lg-4">
                                            <img class="img-responsive" style="height: 100px;width: 100%;" src="http://localhost/www/Prog/public/images/{{$art->imag}}" alt="">
                                        </div>
                                        <div class="col-lg-8" >
                                            <div class="row">
                        ...
                        <div class="card-footer">
                                ...
                                <div>
                                    ...
                                    {{ Form::hidden('_method', 'GET') }}
                                    <button class="btn btn-primary btn-md btn-block"  style="height: 40px;">Validé commande</button>
                                    {{ Form::close() }}
