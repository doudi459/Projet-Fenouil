                ...
                <div class="card card-register mx-auto mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <button type="submit" class="btn btn-md btn-primary col-lg-6"  id="btnEdit" href="#">Modéfier</button>
                                <button type="button" class="btn btn-md btn-danger col-lg-6 "  id="btnEdit1" href="#">Abondoné</button>
...
@section('js')
    ...
    <script src="js/bootstrap-wysihtml5/lib/js/wysihtml5-0.3.0.js"></script>
    <script src="js/bootstrap-wysihtml5/src/bootstrap-wysihtml5.js"></script>
